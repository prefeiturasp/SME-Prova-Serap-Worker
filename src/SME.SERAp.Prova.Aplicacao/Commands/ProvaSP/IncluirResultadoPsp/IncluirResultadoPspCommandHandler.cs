...
namespace SME.SERAp.Prova.Aplicacao
{
    public class IncluirResultadoPspCommandHandler : IRequestHandler<IncluirResultadoPspCommand, bool>
    {
                                                 ...
                                                 IRepositorioParticipacaoEscola repositorioParticipacaoEscola)
        {
            ...
            this.repositorioParticipacaoEscola = repositorioParticipacaoEscola ?? throw new System.ArgumentNullException(nameof(repositorioParticipacaoEscola));
        }
        ...
        public async Task<bool> Handle(IncluirResultadoPspCommand request, CancellationToken cancellationToken)
        {
            ...
            switch (request.Resultado.TipoResultado)
            {
                ...
                case TipoResultadoPsp.ResultadoParticipacaoEscola:
                    return await IncluirParticipacaoEscola();
                default:
                    return false;
            }
        }
        ...
        private async Task<bool> IncluirParticipacaoEscola()
        {
            var participacaoInserir = (ParticipacaoEscola)ObjResultado.Resultado;
            var result = await repositorioParticipacaoEscola.IncluirAsync(participacaoInserir);
            return result > 0;
        }
