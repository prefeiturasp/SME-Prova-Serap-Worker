...
{
    public class ImportarResultadoParticipacaoDreUseCase : AbstractImportarProficienciaPspUseCase, IImportarResultadoParticipacaoDreUseCase
    {

        private TipoResultadoPsp tipoResultadoProcesso = TipoResultadoPsp.ParticipacaoDre;

        public ImportarResultadoParticipacaoDreUseCase(IMediator mediator,
