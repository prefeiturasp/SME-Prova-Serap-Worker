...
{
    public class TratarResultadoParticipacaoDreUseCase : AbstractTratarProficienciaPspUseCase, ITratarResultadoParticipacaoDreUseCase
    {
        private TipoResultadoPsp tipoResultadoProcesso = TipoResultadoPsp.ParticipacaoDre;

        public TratarResultadoParticipacaoDreUseCase(IMediator mediator,
        ...
        public async Task<bool> Executar(MensagemRabbit mensagemRabbit)
        {
            ...
            var objResultadoCsv = registroProficienciaPsp.ObterObjetoRegistro<ParticipacaoDreDto>();
        ...
        private ParticipacaoDre MapearParaEntidade(ParticipacaoDreDto objResultadoCsv)
        {
            return new ParticipacaoDre()
            {
