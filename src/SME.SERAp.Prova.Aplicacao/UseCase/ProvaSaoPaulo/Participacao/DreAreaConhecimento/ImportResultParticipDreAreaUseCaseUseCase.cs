...
{
    public class ImportResultParticipDreAreaUseCaseUseCase : AbstractImportarProficienciaPspUseCase, IImportResultParticipDreAreaUseCaseUseCase
    {
        private TipoResultadoPsp tipoResultadoProcesso = TipoResultadoPsp.ParticipacaoDreAreaConhecimento;

        public ImportResultParticipDreAreaUseCaseUseCase(IMediator mediator,
        ...
        public async Task<bool> Executar(MensagemRabbit mensagemRabbit)
        {
            try
            {
                ...
                {
                    var listaCsvResultados = csv.GetRecords<ParticipacaoDreAreaConhecimentoDto>().ToList();
