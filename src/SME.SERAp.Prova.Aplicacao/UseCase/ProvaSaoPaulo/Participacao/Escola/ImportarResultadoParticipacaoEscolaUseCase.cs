...
{
    public class ImportarResultadoParticipacaoEscolaUseCase : AbstractImportarProficienciaPspUseCase, IImportarResultadoParticipacaoEscolaUseCase
    {
        private TipoResultadoPsp tipoResultadoProcesso = TipoResultadoPsp.ResultadoParticipacaoEscola;

        public ImportarResultadoParticipacaoEscolaUseCase(IMediator mediator,
        ...
        public async Task<bool> Executar(MensagemRabbit mensagemRabbit)
        {
            try
            {
                ...
                {
                    var listaCsvResultados = csv.GetRecords<ParticipacaoEscolaDto>().ToList();
