...
namespace SME.SERAp.Prova.Aplicacao
{
    ...
    {
        public TratarProficienciaCicloEscolaUseCase(IMediator mediator, IServicoLog servicoLog, IConnection rabbitConnection) : base(
            mediator, servicoLog, rabbitConnection)
        {
        }
