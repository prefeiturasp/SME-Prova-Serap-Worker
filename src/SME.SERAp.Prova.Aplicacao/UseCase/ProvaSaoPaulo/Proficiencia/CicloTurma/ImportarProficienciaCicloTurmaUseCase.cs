...
{
    public class ImportarProficienciaCicloTurmaUseCase : AbstractImportarProficienciaPspUseCase, IImportarProficienciaCicloTurmaUseCase
    {
        public ImportarProficienciaCicloTurmaUseCase(IMediator mediator, IServicoLog servicoLog,
        ...
        public async Task<bool> Executar(MensagemRabbit param)
        {
            try
            {
                ...
                {
                    var listaCsvResultados = csv.GetRecords<ResultadoCicloTurmaDto>().ToList();
                    ...
                    foreach (var objCsvResultado in listaCsvResultados)
                    {
                        ...
                        await PublicarFilaTratar(dto, TipoResultadoPsp.ResultadoCicloTurma);
                    }
                }
