...
namespace SME.SERAp.Prova.Dados
{
    public interface IRepositorioAluno : IRepositorioBase<Aluno>
    {
        ...
        Task<IEnumerable<ProvaAlunoTaiSemCadernoDto>> ObterAlunosProvaTaiSemCadernoProvaId(long provaId, string ano);
        ...
        Task<IEnumerable<AlunoCadernoProvaTaiTratarDto2>> ObterAlunoSemProvaTai(long provaId, string ano);
    }
}
