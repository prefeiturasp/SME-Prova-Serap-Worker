...
namespace SME.SERAp.Prova.Dados
{
    public class RepositorioParticipacaoTurma : RepositorioProvaSpBase, IRepositorioParticipacaoTurma
    {
            ...
            try
            {
                var query = $@"
                                UPDATE [dbo].[ParticipacaoTurma]
                                 ...
                                 WHERE
								 Edicao = @Edicao
                                 and uad_sigla = @AreaConhecimentoID
        ...
        private DynamicParameters ObterParametros(ParticipacaoTurma participacao)
        {
            ...
            parametros.Add("@uad_sigla", participacao.UadSigla, DbType.Int16, ParameterDirection.Input,4);
            ...
            parametros.Add("@PercentualParticipacao", participacao.PercentualParticipacao, DbType.Int32, ParameterDirection.Input); ;
