...
namespace SME.SERAp.Prova.Aplicacao.Worker
{
    public class WorkerRabbit : BackgroundService
    {
        ...
        private void RegistrarUseCases()
        {
            ...
            comandos.Add(RotasRabbit.ExcluirDadosConsolidado, new ComandoRabbit("Exclui os dados consolidados para nova exportação", typeof(IExcluirDadosConsolidadoUseCase)));
            comandos.Add(RotasRabbit.ConsolidarProvaResultado, new ComandoRabbit("Realiza consolidação dos dados da prova para exportação", typeof(IConsolidarProvaResultadoUseCase)));
            comandos.Add(RotasRabbit.ExtrairResultadosProva, new ComandoRabbit("Realiza a extração dos dados de uma prova", typeof(IExtracaoProvaResultadoUseCase)));
